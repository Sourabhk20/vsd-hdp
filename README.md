...
12. [Day 11](https://github.com/Sourabhk20/vsd-hdp/blob/main/README.md#day-11) - **Sandpiper and fusesoc implementation**
...
## Sanpiper and fusesoc implemnetation

	As fusesoc helps to convert TLV verilog to the System verilog file, I used an adder example to convert it from TLV to SV.
 	Adder core is the file which will serve as the main file for this conversion, which has a different argumnets.


  Below is the sv file generated by Sandpiper:

   			
			`line 2 "1_adder.tlv" 0 //_\TLV_version 1d: tl-x.org, generated by SandPiper(TM) 1.14-2022/10/10-beta-Pro
			`line 9 "1_adder.tlv" 1
			//_\SV
			   // Macro providing required top-level module definition, random
			   // stimulus support, and Verilator config.
			module top(input wire clk, input wire reset, input wire [31:0] cyc_cnt, output wire passed, output wire failed);    /* verilator lint_save */ /* verilator lint_off UNOPTFLAT */  bit 				[256:0] RW_rand_raw; bit [256+63:0] RW_rand_vect; pseudo_rand #(.WIDTH(257)) pseudo_rand (clk, reset, RW_rand_raw[256:0]); assign RW_rand_vect[256+63:0] = {RW_rand_raw[62:0], 					RW_rand_raw};  /* verilator lint_restore */  /* verilator lint_off WIDTH */ /* verilator lint_off UNOPTFLAT */   // (Expanded in Nav-TLV pane.)
			// ---------- Generated Code Inlined Here (before 1st \TLV) ----------
			`line 0 "[1_adder_rtl_2.sv]" 1
			...
			// ---------- Generated Code Ends ----------
			`line 15 "1_adder.tlv" 2
			//_\TLV
			   assign L0_reset_a0 = reset;
			
			   assign L0_in1_a0 = 1'b1;
			   assign L0_in2_a0 = 1'b0;
			   assign L0_sel_a0 = 1'b1;
			
			   //$out = 1'b0;
			
			   assign L0_out_a0 = L0_sel_a0 ? L0_in1_a0 : L0_in2_a0;
			   //...
			
			   `BOGUS_USE(L0_reset_a0 L0_out_a0)
   ...
   Now I converted this sv file into verliog and made changes manually to the verilog file and I executed iverilog file_name.v

   		

		module top(input wire clk, input wire reset, input wire [31:0] cyc_cnt, output wire passed, output wire failed);    
		///* verilator lint_save */ /* verilator lint_off UNOPTFLAT */  bit [256:0] RW_rand_raw; bit [256+63:0] RW_rand_vect; pseudo_rand #(.WIDTH(257)) pseudo_rand (clk, reset, RW_rand_raw[256:0]); 			assign RW_rand_vect[256+63:0] = {RW_rand_raw[62:0], RW_rand_raw};  /* verilator lint_restore */  /* verilator lint_off WIDTH */ /* verilator lint_off UNOPTFLAT */   // (Expanded in Nav-TLV pane.)
		// ---------- Generated Code Inlined Here (before 1st \TLV) ----------
		//`line 0 "[1_adder_rtl_2.sv]" 1
		// Generated by SandPiper(TM) 1.14-2022/10/10-beta-Pro from Redwood EDA, LLC.
		// Redwood EDA, LLC does not claim intellectual property rights to this file and provides no warranty regarding its correctness or quality.
...
Suuceesful run of the verilog file.

![image](https://github.com/Sourabhk20/vsd-hdp/assets/148907305/b8d84737-962c-4d87-b3af-775c1e136c7a)


Now, my task is to convert the RISCV core that I completed in the makerchip format into the successful verilog implementation.
And to find how sandpiper could be used to convert directly into verilog file instead of SV file.
